                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Receive budget alerts and summaries via email</p>
                    </div>
            ...
            {activeSection === 'privacy' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      <h4 className="font-semibold text-gray-800">Share Usage Data</h4>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      <h4 className="font-semibold text-gray-800">Marketing Communications</h4>
                ...
                <div className="p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <p className="text-sm text-yellow-800">
                    <strong>Privacy Notice:</strong> All your data is stored locally on your device. We do not collect or store personal information on external servers.
                  </p>
                </div>
              </div>
            )}
